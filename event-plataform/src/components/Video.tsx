    ...
    return(
        <div className="flex-1">
            ...
            <div className="p-8 max-w[1100] mx-auto">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mt-6">
                                ...
                                <div className="leading-relaxed">
                                    ...
                                    <span className="text-gray-200 text-sm block">{data.lesson.teacher.bio}.</span><br></br>
                                </div>
                            </div>
                             ) }
                        </div>
                ...
                <div className="gap-8 mt20 grid grid-cols-2">
                ...
                <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                    ...
                    <div className="py-6 leading-relaxed">
                        ...
                        <p className="text-sm text-gray-200 mt-2">
                        Baixe os Wallspapers Exclusivos do Ignite Lab e personalize a sua máquina
                        </p>
                    </div>
                    <div className="h-full p-6 flex items-center">
                            <CaretRight size={24}/>
